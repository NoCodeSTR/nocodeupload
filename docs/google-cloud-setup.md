...
4. App domain:
   ...
   - **Application privacy policy link:** `https://nocodeupload.com/privacy` (we'll add this page later)
   - **Application terms of service link:** `https://nocodeupload.com/terms` (we'll add this later)
