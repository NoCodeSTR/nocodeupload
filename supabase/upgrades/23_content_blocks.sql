-- =============================================================================
-- Upgrade: content blocks — ordered presentational blocks (heading / text /
-- divider) shown at the top of the public form, with merge-tag personalization.
-- =============================================================================
-- content_blocks jsonb on upload_links: ordered array of { id, type
--   (heading|text|divider), text }. Safe to expose publicly (presentational).
-- Safe to run once.
-- =============================================================================

alter table public.upload_links add column if not exists content_blocks jsonb;

-- Public view: add content_blocks. DROP + CREATE (adding a column mid-list).
