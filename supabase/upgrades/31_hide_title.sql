-- =============================================================================
-- Upgrade: allow hiding the form title on the public page.
-- =============================================================================
-- Some owners brand the form entirely through their logo + content blocks and
-- don't want the link name shown as a big heading. This flag lets them hide it.
-- The public uploader needs the flag, so the public view must project it.
