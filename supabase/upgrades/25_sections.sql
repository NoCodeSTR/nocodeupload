-- =============================================================================
-- Upgrade: form sections — group fields under a heading + intro text.
-- =============================================================================
-- sections jsonb on upload_links: ordered array of { id, heading, text }.
-- Each custom field gains an optional sectionId (stored inside custom_fields)
-- assigning it to a section; the public view now projects sectionId too.
-- Safe to run once.
-- =============================================================================

alter table public.upload_links add column if not exists sections jsonb;
