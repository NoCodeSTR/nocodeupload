-- =============================================================================
-- Upgrade: upload boxes in sections — expose each box's sectionId publicly.
-- =============================================================================
-- sectionId lives inside the upload_boxes jsonb (no column change); the public
-- view just needs to project it so the public form can place each box inside
-- its section. Safe to run once.
-- =============================================================================
